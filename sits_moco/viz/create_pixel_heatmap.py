...
def season_start_from_year_range(year_range: str) -> date:
    ...
    from preprocessing.season_calendar import season_start_from_year_range as _ss

    return _ss(year_range)
...
def date_to_season_doy(d: date, season_start: date) -> int:
    ...
    from preprocessing.season_calendar import date_to_season_doy as _doy

    return _doy(d, season_start)
